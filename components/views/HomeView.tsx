        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12 md:gap-16">
           <div className="order-2 md:order-1 flex-1 text-center md:text-left">
              ...
              <h2 className="text-neutral-900 dark:text-neutral-100 font-semibold border-b-2 border-emerald-500/30 pb-0.5">
                 A Full Stack Developer and <span className="text-neutral-900 dark:text-neutral-100 font-semibold border-b-2 border-emerald-500/30 pb-0.5">Innovative Engineer</span>
              </h2>
              
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed max-w-2xl mb-10 mx-auto md:mx-0 text-lg">
                I build interactive web apps using <Badge>TypeScript</Badge>, <Badge>React</Badge>, <Badge>Next.js</Badge>, and <Badge>Bun</Badge>. With a focus on <strong className="text-neutral-900 dark:text-white">UI And Latest Interactive</strong> design. Enthusiastic about <strong className="text-neutral-900 dark:text-white">Software Development </strong>, driven by a keen eye for Saas based Application
              </p>
